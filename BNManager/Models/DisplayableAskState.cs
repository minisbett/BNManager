...
/// </summary>
internal class DisplayableAskState
{
  /// <summary>
  /// The ask state.
  /// </summary>
  ...
  public DisplayableAskState(AskState state)
  {
    State = state;
  }
  ...
  /// </summary>
  public static DisplayableAskState[] Options { get; } = Enum.GetValues<AskState>().Select(x => new DisplayableAskState(x)).ToArray();
}